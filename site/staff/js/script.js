...
$(document).ready(function(){
    $(".header").affix();
    //addClassBasedOnLocation(); // 호출 20240514
});
...
//프로그램 관리 > 강좌관리 > 강좌 접수 20240514
// function addClassBasedOnLocation() {
//     if (window.location.pathname === "/staff/selectMngrLectureAllInOneForm.do" && window.location.port === "8216") {
